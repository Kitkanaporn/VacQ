...
exports.getAppointments = async (req,res,next) => {
    ...
    if(req.user.role !== 'admin') {
        ...
        if (req.params.hospitalId) {
                console.log("hospitalId is " , req.params.hospitalId) ;
